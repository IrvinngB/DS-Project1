document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch('obtener_datos.php?accion=obtenerProvincias')
        .then(response => {
            if (!response.ok) {
...
function cargarDistritos(codigoProvincia) {
    ...
    fetch(`obtener_datos.php?accion=obtenerDistritos&codigo_provincia=${codigoProvincia}`)
        .then(response => {
            if (!response.ok) {
                throw new Error('Error en la respuesta del servidor');
            }
...
function cargarCorregimientos(codigoDistrito) {
    ...
    fetch(`obtener_datos.php?accion=obtenerCorregimientos&codigo_distrito=${codigoDistrito}`)
        .then(response => {
            if (!response.ok) {
                throw new Error('Error en la respuesta del servidor');
            }
